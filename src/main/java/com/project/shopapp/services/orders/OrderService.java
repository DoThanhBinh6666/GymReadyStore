...
public class OrderService implements IOrderService{
    ...
    @Override
    public List<OrderResponse> findActiveOrdersByUserId(Long userId) {
        List<Order> orders = orderRepository.findActiveOrdersByUserId(userId);  // Dùng phương thức mới trong repository
