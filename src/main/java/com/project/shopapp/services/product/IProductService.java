...
public interface IProductService {
    ...
    // Thêm phương thức để cập nhật trạng thái active của sản phẩm
    void activateProduct(Long productId) throws Exception;
    Page<ProductResponse> searchInactiveProducts(String keyword, PageRequest pageRequest);
    Product updateInactiveProduct(long id, ProductDTO productDTO) throws Exception;
}
